...
class Workspace {
    ...
    _canvasObjectHandler(parent, callback){
        return function(options) {
            ...
            // return objects data
            const data = {
                id: options.target.parentObject.id,
                type: options.target.parentObject.type,
                label: options.target.parentObject.label,
                visualId: options.target.parentObject.visualId
            }
